...
public class StockAnalysis {
    ...
    //set variables
    String[] values = new String[]{"Product Name", "Serial Number", "Stock In", "Stock In Cost", "Stock Out", "Stock Out Cost", "Total Profit", "Total Deficit", "Saved On","Updated On"};
            ...
            try {
                ...
                if (rs.next()) {
                    do {
                        ...
                        pharmacymodel.addRow(new String[]{drugname, drugserial, sinstock, sincost, soutstock, soutcost, sprofit, sloss, drugeditedon,drugupdate});
                ...
                do {
                    ...
                    while (rs2.next()) {
                        ...
                        while (rs3.next()) {
                            ...
                            if (rs4.next()) {
                                if (finalprofit >= 1) {
                                    String updatetablecitical = "UPDATE tablecritical set UpdatedOn   = '" + fileeditedlast + "',StockOut   = '" + storeout + "',StockOutCost  = '" + storecostout + "',Profit  = '" + finalprofit + "' WHERE Mserial = '" + storeserial + "'";
                                    prs = con.prepareStatement(updatetablecitical);

                                    prs.execute();
                                } else {
                                    String updatetablecitical = "UPDATE tablecritical set UpdatedOn   = '" + fileeditedlast + "',StockOut   = '" + storeout + "',StockOutCost  = '" + storecostout + "',Profit  = '" + finalvalue + "' WHERE Mserial = '" + storeserial + "'";
                                    prs = con.prepareStatement(updatetablecitical);

                                    prs.execute();
                                }
                                if (finalloss >= 1) {
                                    String updatetablecitical = "UPDATE tablecritical set UpdatedOn   = '" + fileeditedlast + "',StockOut   = '" + storeout + "',StockOutCost  = '" + storecostout + "',Loss  = '" + finalloss + "' WHERE Mserial = '" + storeserial + "'";
                                    prs = con.prepareStatement(updatetablecitical);

                                    prs.execute();
                                } else {
                                    String updatetablecitical = "UPDATE tablecritical set UpdatedOn   = '" + fileeditedlast + "',StockOut   = '" + storeout + "',StockOutCost  = '" + storecostout + "',Loss  = '" + finalvalue + "' WHERE Mserial = '" + storeserial + "'";
                                    prs = con.prepareStatement(updatetablecitical);
                                ...
                                String sqladd = "INSERT INTO tablecritical(Mname,Mserial,StockIn,StockInCost,StockOut,StockOutCost,Profit,Loss,UpdatedOn,LastEdited) VALUES (?,?,?,?,?,?,?,?,?,?)";
