...
public class SellAnalysis {
    ...
    //set variables
    String[] values2 = new String[]{"Product_Name", "Serial_Number", "Sold_Quantity", "Buying_Price", "Selling_Price", "Total_Cost", "Cash Paid", "Change Given", "Invoice_NO", "Sold On"};
            ...
            try {
                ...
                if (rs.next()) {
                    do {
                        ...
                        pharmacymodel.addRow(new String[]{cname, cidentity, ccost, spay, sbalance, sbalance1, sbpaid, schange, pinvoice, cedited});
