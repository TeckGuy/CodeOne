            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (verifyquantity < limit) {
                        ...
                        JOptionPane.showMessageDialog(null, "Sorry Only " + " " + quantityfound + " " + " Items In Stock", "Stock Notification", JOptionPane.INFORMATION_MESSAGE);
                    ...
                    if (rs.next()) {
                        ...
                        if (quantityfound <= 0) {
                            ...
                            if ((tsearch.getText().equalsIgnoreCase("") || tsearch.getText().equalsIgnoreCase(null)) && (drugname != null)) {
                                selloption = JOptionPane.showOptionDialog(null, "Proceed in Selling" + " " + quaty + " " + drugname + " " + "at" + " " + String.format("%.2f", total) + "/=", "Sell Confirmation", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, option, option[1]);
                            } else if ((drugname == "" || drugname == null) && (!tsearch.getText().equals("") || tsearch.getText() != null)) {
                                selloption = JOptionPane.showOptionDialog(null, "Proceed in Selling" + " " + quaty + " " + tsearch.getText() + " " + "at" + " " + String.format("%.2f", total) + "/=", "Sell Confirmation", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, option, option[1]);
                            }
                            if (selloption == 0) {
